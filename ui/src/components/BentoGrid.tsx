  ...
  return (
    <div id={id} className="min-h-[80vh] py-32 border-t border-white/[0.05] first:border-0 relative grid grid-cols-1 xl:grid-cols-12 gap-12 xl:gap-16 items-center">
      <div className="xl:col-span-5 w-full">
        <h2 className="text-[32px] md:text-[36px] font-semibold text-white tracking-tight leading-[1.1] mb-6 drop-shadow-sm">
          {title}
        </h2>
      ...
      <div className="xl:col-span-7 relative w-full rounded-xl border border-white/[0.15] bg-[#050505] overflow-hidden flex items-center justify-center p-6 sm:p-10 shadow-2xl">

        {/* Neutral Dotted Mesh Background for the Card */}
        <div className="absolute inset-0 pointer-events-none z-0">
          <div
            className="absolute inset-0 bg-white/15"
            style={{
              WebkitMaskImage: 'radial-gradient(circle at center, black 1.2px, transparent 1.8px)',
              WebkitMaskSize: '10px 10px',
              maskImage: 'radial-gradient(circle at center, black 1.2px, transparent 1.8px)',
              maskSize: '10px 10px'
            }}
          />

          {/* Subtle vignette so the dots fade cleanly at the edges of the card */}
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_20%,black_100%)] opacity-60" />
        </div>
...
export default function BentoGrid() {
  ...
  return (
    <section className="bg-black relative w-full">
      ...
      {/* 
        ========================================================================
        The Glowing Dotted Mesh Background for the Entire Section
        ========================================================================
      */}
      <div className="absolute inset-0 w-full h-full pointer-events-none z-0 overflow-hidden">
        ...
        >
          {/* Neon Cyan Blob (Left) */}
          {/* <div className="absolute top-[10%] left-0 w-[800px] h-[800px] bg-[#0ea5e9]/70 rounded-full blur-[120px] -translate-x-1/2" /> */}

          {/* Neon Orange Blob (Right Middle) */}
          {/* <div className="absolute top-[40%] right-0 w-[900px] h-[900px] bg-[#f97316]/50 rounded-full blur-[130px] translate-x-1/3" /> */}

          {/* Neon Emerald Blob (Bottom Left) */}
          {/* <div className="absolute bottom-[5%] left-0 w-[700px] h-[700px] bg-[#10b981]/50 rounded-full blur-[100px] -translate-x-1/2" />  */}
        </div>

        {/* Vignette overlay to darken the edges and prevent dots from overwhelming content */}
        {/* <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_0%,black_100%)] opacity-60" /> */}
      </div>

      {/* Main Content */}
      <div className="relative z-10 w-full max-w-[1442px] mx-auto px-10">
        <div className="flex relative">

          {/* Sticky Sidebar */}
          <div className="hidden lg:block w-[280px] shrink-0 py-32 sticky top-0 h-screen self-start">
                ...
                <li key={section.id}>
                  ...
                  >
                    {activeSection === section.id && (
                      <span className="w-1.5 h-1.5 rounded-full bg-white mr-3 shadow-[0_0_10px_white]"></span>
                    )}
